...
<div className="flex justify-between items-start mt-24">
  ...
  <div className="ml-auto w-120 rounded-lg border border-gray-400 p-5">
    ...
    <div className="flex justify-between text-xl font-medium mb-7">
      <span>Total:</span>
      <span>{`$${total.toFixed(2)}`}</span>
    </div>

    <div className="flex justify-center">
      <Link to={'/cart/checkout'} className="bg-red-500 hover:bg-red-600 text-white px-14 py-4 rounded-md text-lg font-medium transition active:scale-95">
        Proceed to checkout
      </Link>
    </div>
